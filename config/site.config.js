...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'leopard99@outlook.com',
  ...
  protectedRoutes: ['/CFShare/Private'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:leopard@skiff.com',
